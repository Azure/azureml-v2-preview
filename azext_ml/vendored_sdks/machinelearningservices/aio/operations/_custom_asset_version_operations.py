...
class CustomAssetVersionOperations:
    """CustomAssetVersionOperations async operations.
    ...
    async def get(
        ...
        **kwargs
    ) -> "models.CustomAssetVersionResource":
        """Get asset.
    ...
    async def create_or_update(
        ...
        custom_asset_type: Optional[Union[str, "models.CustomAssetType"]] = None,
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.CustomAssetVersionResourceArmPaginatedResult"]:
        """Get asset.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_machine_learning_workspaces.models.CustomAssetVersionResourceArmPaginatedResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
