...
class ModelContainerOperations(object):
    """ModelContainerOperations operations.
    ...
    def delete(
        ...
        **kwargs  # type: Any
        ...
        :param name: Model container name.
        :type name: str
        :param subscription_id:
        :type subscription_id: str
        :param resource_group_name:
    ...
    def create_or_update(
        ...
        latest_versions=None,  # type: Optional[List["models.ModelVersionResource"]]
        ...
        **kwargs  # type: Any
        ...
        body = models.ModelContainerResource(system_data=system_data, latest_versions=latest_versions, description=description, tags=tags, properties=properties)
