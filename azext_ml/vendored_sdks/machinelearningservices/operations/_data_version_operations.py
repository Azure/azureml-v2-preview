...
class DataVersionOperations(object):
    ...
    def create_or_update(
        ...
        dataset_type=None,  # type: Optional[Union[str, "models.DatasetType"]]
        ...
        **kwargs  # type: Any
        ...
        """Create or update dataset. Update options: tags, description, and/or properties.
        ...
        :param dataset_type: The Format of dataset.
        ...
        body = models.DataVersionResource(system_data=system_data, dataset_type=dataset_type, datastore_id=datastore_id, asset_path=asset_path, linked_resource_ids=linked_resource_ids, description=description, tags=tags, properties=properties)
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :param name: Dataset name to filter for.
        :type name: str
        :param subscription_id:
        :type subscription_id: str
        :param resource_group_name:
