...
class BatchDeploymentOperations(object):
    """BatchDeploymentOperations operations.
    ...
    def create_or_update(
        ...
        scale_settings=None,  # type: Optional["models.DeploymentScaleSettings"]
        batch_settings=None,  # type: Optional["models.BatchDeploymentSettings"]
        description=None,  # type: Optional[str]
        properties=None,  # type: Optional[Dict[str, str]]
        model_reference=None,  # type: Optional["models.AssetReferenceBase"]
        code_configuration=None,  # type: Optional["models.CodeConfiguration"]
        ...
        **kwargs  # type: Any
        ...
        :param id: The identifier for the Batch inference deployment.
        :type id: str
        ...
        body = models.BatchDeploymentResource(system_data=system_data, scale_settings=scale_settings, batch_settings=batch_settings, description=description, properties=properties, model_reference=model_reference, code_configuration=code_configuration, environment_id=environment_id)
        ...
        if body is not None:
            body_content = self._serialize.body(body, 'BatchDeploymentResource')
        else:
            body_content = None
        ...
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/batchEndpoints/{endpointName}/deployments/{id}'}  # type: ignore
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :type endpoint_name: str
        :param id: The identifier for the Batch deployments.
        :type id: str
        :param subscription_id:
        :type subscription_id: str
        :param resource_group_name:
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/batchEndpoints/{endpointName}/deployments/{id}'}  # type: ignore
    ...
    def delete(
        ...
        **kwargs  # type: Any
        ...
        :param endpoint_name: Endpoint name.
        :type endpoint_name: str
        :param id: Inference deployment identifier.
        :type id: str
        :param subscription_id:
        :type subscription_id: str
        :param resource_group_name:
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/batchEndpoints/{endpointName}/deployments/{id}'}  # type: ignore
