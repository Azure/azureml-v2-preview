...
class LabelingJobOperations(object):
    """LabelingJobOperations operations.
    ...
    def create_or_update(
        ...
        job_type=None,  # type: Optional[Union[str, "models.JobType"]]
        description=None,  # type: Optional[str]
        tags=None,  # type: Optional[Dict[str, str]]
        properties=None,  # type: Optional[Dict[str, str]]
        label_categories=None,  # type: Optional[Dict[str, "models.LabelCategory"]]
        job_instructions=None,  # type: Optional["models.LabelingJobInstructions"]
        dataset_configuration=None,  # type: Optional["models.LabelingDatasetConfiguration"]
        ml_assist_configuration=None,  # type: Optional["models.MlAssistConfiguration"]
        labeling_job_media_properties=None,  # type: Optional["models.LabelingJobMediaProperties"]
        project_id=None,  # type: Optional[str]
        status=None,  # type: Optional[Union[str, "models.JobStatus"]]
        progress_metrics=None,  # type: Optional["models.ProgressMetrics"]
        status_messages=None,  # type: Optional[List["models.StatusMessage"]]
        created_time_utc=None,  # type: Optional[datetime.datetime]
        **kwargs  # type: Any
    ):
