...
class PrivateEndpointConnectionOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        if response.status_code not in [200]:
            ...
            error = self._deserialize(models.ErrorResponseautogenerated2, response)
    ...
    def put(
        ...
        user_assigned_identities=None,  # type: Optional[Dict[str, "models.UserAssignedIdentity"]]
        ...
        **kwargs  # type: Any
        ...
        :type user_assigned_identities: dict[str, ~azure_machine_learning_workspaces.models.UserAssignedIdentity]
        ...
        properties = models.PrivateEndpointConnection(location=location, tags=tags, sku=sku, type_identity_type=type, user_assigned_identities=user_assigned_identities, private_endpoint=private_endpoint, private_link_service_connection_state=private_link_service_connection_state)
        api_version = "2020-06-01"
