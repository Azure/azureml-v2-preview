...
class EnvironmentSpecificationVersionOperations(object):
    """EnvironmentSpecificationVersionOperations operations.
    ...
    def create_or_update(
        ...
        environment_version,  # type: str
        subscription_id,  # type: str
        resource_group_name,  # type: str
        workspace_name,  # type: str
        api_version="1.0.0",  # type: Optional[str]
        type=None,  # type: Optional[Union[str, "models.EnvironmentSpecificationType"]]
        docker=None,  # type: Optional["models.DockerProperties"]
        python=None,  # type: Optional["models.PythonProperties"]
        runtime=None,  # type: Optional[str]
        r_install=None,  # type: Optional[str]
        spark_maven_pom=None,  # type: Optional[str]
