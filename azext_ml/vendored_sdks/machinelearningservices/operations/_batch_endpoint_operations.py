...
class BatchEndpointOperations(object):
    """BatchEndpointOperations operations.
    ...
    def create_or_update(
        ...
        traffic_rules=None,  # type: Optional[Dict[str, int]]
        compute_configuration=None,  # type: Optional["models.ComputeConfiguration"]
        auth_mode=None,  # type: Optional[Union[str, "models.EndpointAuthModeType"]]
        keys=None,  # type: Optional["models.AuthKeys"]
        **kwargs  # type: Any
    ):
    ...
    def list_key(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.InferenceEndpointKeysTrackedResource"
