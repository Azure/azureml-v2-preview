...
class CodeContainerOperations(object):
    """CodeContainerOperations operations.
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :param name: Code container name.
        :type name: str
        ...
        body = models.CodeContainerResource(system_data=system_data, properties=properties, tags=tags, description=description)
    ...
    def delete(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> None
        """Delete Code Container entity.

        Delete Code Container entity.

        :param name: Code Container identifier.
        :type name: str
        :param subscription_id:
        :type subscription_id: str
        :param resource_group_name:
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        """Lists code containers in the workspace.
