...
class CodeVersionOperations(object):
    """CodeVersionOperations operations.
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        body = models.CodeVersionResource(system_data=system_data, datastore_id=datastore_id, asset_path=asset_path, linked_resource_ids=linked_resource_ids, description=description, tags=tags, properties=properties)
